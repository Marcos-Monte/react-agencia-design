...
const Rodape = () => {
    return (
        <footer className="rodape">
            ...
            <p>Ajudamos a criar uma personalidade digital contruindo sua marca no ambiente online utilizando estratégias, ferramentas e tecnologias personalizadas.</p>
